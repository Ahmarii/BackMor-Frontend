        ...
        <LoginLayout>
            <main className=" static flex flex-col justify-center items-center min-h-screen ">
                ...
                <form className="z-10 w-2/3 md:max-w-xl py-2 flex flex-col justify-center items-center">
                    ...
                    <input type="submit" value="Login" className="w-full h-10 bg-black text-white border-solid border-2 rounded-md max-w-60 cursor-pointer" />
                ...
                <div className="z-10 flex flex-col justify-center items-center">
                    <h1>or</h1>
                    <h1><a href="" className=" text-blue-400 font-semibold cursor-pointer">Reset Password</a></h1>
                    <h1>No account? <Link href="/login/register" className=" text-blue-400 font-semibold cursor-pointer">Create one</Link></h1>
