    ...
    return (
        <>
            <main>
                ...
                <nav className="bg-[#535353] p-4 px-8">
                    ...
                    {isMenuOpen ? (
                            <ul className="flex-col md:hidden ">
                                ...
                                <div className=" p-2 bg-[#D9D9D9] rounded-xl">
                                    <h1 className="text-[#474747] text-xl">Lastest Pin</h1>
                                </div>
                            </ul>
                        ): null}
                </nav>

                <div className="z-10  fixed top-15 right-0 w-60 h-4/6 m-10 p-3 rounded-3xl bg-[#D9D9D9] font-medium hidden md:flex">
                    <h1 className="text-3xl text-[#474747]">Lastest Pin</h1>
                </div>
